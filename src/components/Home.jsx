    ...
    <div name="home" className="h-screen w-full bg-[#0A192F]">
      <div className="max-w-screen-xl mx-auto flex flex-col items-center justify-center h-full w-full px-4 md:flex-row">
        <div className="flex flex-col justify-center h-full" >
          <h2 className="md:text-2xl text-lg font-bold text-[#5CEACA] " data-aos="fade-right">
            Hi
            <span className="wave">👋</span>
            my name is,
          </h2>
          <h3 className="text-[#CCD6f6] md:text-9xl text-5xl font-bold py-4 max-w-7xl " data-aos="fade-left">
            Aswin Malla.
          </h3>
          <h3 className="text-[#8892B0] md:text-5xl text-2xl font-bold py-4 max-w-7xl" data-aos="fade-left">
           A PERN-stack Developer
          </h3>
          <div >
            <p className="md:text-2xl sm:text-xl max-w-7xl  font-bold text-[#8892b0]" data-aos="fade-left">
              I am a
              <Typed
